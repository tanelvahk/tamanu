...
jQuery(document).ready(function ($) {
    ...
    var features = document.getElementsByClassName("hestia-features-content")[0];
    if(features){
        var featureLink = document.createElement('a');
        featureLink.innerHTML = "Vaata kõiki õli omadusi";
        featureLink.className = "btn btn-primary btn-lg";
        featureLink.title = "Loe Rohkem";
        featureLink.href = "/tamanu-oli/";
        features.append(featureLink);
    }
    ...
    if ($('.navbar-color-on-scroll').length !== 0) {
        ...
        var navBarLogo = $('.navbar-header .navbar-brand img');
        ...
        $(window).on('scroll', debounce(function () {
            if ($(document).scrollTop() > headerWithTopbar) {
                if (transparent) {
                    ...
                    navBarLogo.addClass("decreaseSize");
                }
            } else {
                if (!transparent) {
                    transparent = true;
                    ...
                    navBarLogo.removeClass("decreaseSize");
                }
            }
        }, 17));
    }
